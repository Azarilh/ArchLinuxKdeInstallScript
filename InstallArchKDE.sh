...
echo "Press ENTER to open Vim."
read
vim Resources/extra.txt
extra=$(cat Resources/extra.txt)
...
echo "Press ENTER to open Vim."
read
vim Resources/extra2.txt
extra2=$(cat Resources/extra2.txt)
